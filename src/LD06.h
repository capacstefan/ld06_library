...
class LD06{                                                                                        // LD06 will be the class of the lidar
  public:
    ...
    std::vector<RawPoint> getRawPoints(int RANGE);												   // Returning a vector with the points read, along with their raw data (angle, distance)    //    std::vector<IndexedPoint> IndexedPointsContainer();											   // Initializing a container for IndexedPoints
